          ...
          <div class="pt-4 pb-3 border-t border-sky-800">
            <div class="flex items-center px-4">
              <div class="flex-shrink-0">
                <img  class="rounded-full h-8 w-8"  src="../../assets/yo.png"   alt=""/>
              </div>
              <div class="ml-3">
                <div class="text-base font-medium text-white">{{ currentUser.name }}</div>
                <div class="text-sm font-medium text-sky-200">{{ currentUser.email }}</div>
              </div>
              <button type="button"
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
          <div class="divide-y divide-gray-200 lg:grid lg:grid-cols-12 lg:divide-y-0 lg:divide-x">
            <aside class="py-6 lg:col-span-3">
             ...
             <FormDatosUsuario   :idUsuario="currentUser.idUsuario"  @salir="salir"></FormDatosUsuario>
  ...
  data() {
    return {
      ...
      subNavigation: [
        ...
        { name: 'Mi Perfil', href: '/settings/profile', icon: UserCircleIcon, current: true },
        { name: 'Cuentas', href: '/settings', icon: UserGroupIcon, current: false },
      ...
      userNavigation: [
        ...
        { name: 'Cerrar sesion', href: '/logout' },
          ...
          availableToHire : ref(true),
    privateAccount: ref(false),
    allowCommenting :ref(true),
    allowMentions : ref(true)
    }
